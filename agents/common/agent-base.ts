...
export abstract class AgentBase {
  ...
  /**
   * Realiza un escaneo de malware
   */
  protected abstract scanForMalware(): Promise<void>;
  
  /**
   * Realiza un escaneo de vulnerabilidades
   */
  protected abstract scanForVulnerabilities(): Promise<void>;
}