import { playbookExecutor, type ActionFn, type ActionContext } from '../services/playbookExecutor';

// Core notification actions
const notifySlack: ActionFn = async (ctx: ActionContext, input: any) => {
...
const createTicket: ActionFn = async (ctx: ActionContext, input: any) => {
...
const isolateHost: ActionFn = async (ctx: ActionContext, input: any) => {
...
const killProcess: ActionFn = async (ctx: ActionContext, input: any) => {
...
const quarantineFile: ActionFn = async (ctx: ActionContext, input: any) => {
...
// Analysis actions
const queryAssetRisk: ActionFn = async (ctx: ActionContext, input: any) => {
  const { hostId } = input;
