...
export class BlockIpAction extends BaseAction {
    ...
    async execute(params, context) {
        try {
            ...
            this.log(context, `IP ${validParams.ipAddress} blocked successfully. Rule ID: ${ruleResult.ruleId}. ` +
                `Duration: ${validParams.duration ? `${validParams.duration} minutes` : 'permanent'}`);
            return this.success(`IP ${validParams.ipAddress} blocked successfully`, {
    ...
    async isWhitelistedIp(ipAddress, context) {
    ...
    async createBlockRule(params, context) {
