...
import { BaseConnector, ConnectorType as OldConnectorType } from './base';
...
import { initializeConnectors as initNewConnectors } from './connector-init';
...
OldConnectorType as ConnectorType, BaseConnector, APIConnector, SyslogConnector, AgentConnector, VirusTotalConnector, OTXConnector, MISPConnector, connectorRegistry, connectorScheduler, EnhancedSyslogConnector, EnhancedAgentConnector, AwsCloudWatchLogsConnector, GoogleWorkspaceConnector, ConnectorFactory, eventPipeline };
 ...
 */
export async function initializeConnector(connector, app) {
    try {
 ...
 * This is kept for backward compatibility
 */
export function shutdownConnector(connectorId) {
 ...
 * This is kept for backward compatibility
 */
export async function toggleConnector(connectorId, active) {
    try {
 ...
 */
export async function runConnector(connectorId) {
    try {
 ...
 */
export async function testConnectorConnection(connectorId) {
    try {
