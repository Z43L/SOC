...
export class FileConnector extends BaseConnector {
  ...
  constructor(config: ConnectorConfig) {
    ...
    const fileConfig = this._config as FileMonitorConfig;
   ...
   */
  private validateFileConfig(config: FileMonitorConfig): void {
   ...
   */
  private buildIgnorePatterns(config: FileMonitorConfig): RegExp[] {
   ...
   */
  private determineSeverity(eventData: FileEventData): 'info' | 'warn' | 'error' | 'critical' {
   ...
   */
  private buildEventMessage(eventData: FileEventData): string {
