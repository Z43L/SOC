...
export class AnomalyDetector {
    ...
    sensitivityThreshold = 0.85; // 0-1 range, higher = more sensitive
    constructor() {
     ...
     */
    async generateAnomalyInsight(hostId, anomalyResults) {
        ...
        try {
            ...
            const aiInsight = await detectAnomalies([JSON.stringify(anomaliesData, null, 2)], {
                host: hostId,
     ...
     */
    createBasicInsight(hostId, anomalyResults) {
