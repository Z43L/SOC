...
export async function registerRoutes(app) {
    ...
    function generateMockGeoLocation(ip) {
            ...
            const threatLocations = alertsInRange
                ...
                if (geoData && geoData.lat && geoData.lon) {
                    ...
                    if (existingLocation) {
                        ...
                        existingLocation.lastSeen = new Date(Math.max(new Date(existingLocation.lastSeen).getTime(), new Date(alert.timestamp).getTime()));
                        ...
                        if (severityOrder[alert.severity] > severityOrder[existingLocation.severity]) {
